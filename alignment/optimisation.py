...
def optimal_vector_field(A: GridForm2D, B: GridForm2D, heaviside_eps=0.5, sdf_iter=100, drawers=None):
    """
    Get the optimal deformation field of one form to another
    :param A: A form
    :param B: B form
    :param heaviside_eps:
    :param sdf_iter:
...
def optimise(grid: Grid2D, A: GridForm2D, B: GridForm2D, nb_iter, heaviside_eps=0.5, sdf_iter=100, descent_step=0.2, deform=False):
    """
    Perform the alignment optimisation between two shapes
    :param grid: Grid used for calculations
    :param A: Model shape
    :param B: Target shape
    :param nb_iter: Max iterations
    :param heaviside_eps:
    :param sdf_iter: Number of iterations for sdf calculation
    :param descent_step:
    :param deform: Allow for shape deformation
    :return: (Transformed shape, similarity)
    """
    if deform:
